...
const addCustomer = async (req, res, data) => {
    ...
    try {
        ...
        if (existingCustomer) {
            ...
            return (0, _helpers_1.sendResponse)(res, 409, 'მომხმარებელი მსგავსი ელ.ფოსტით უკვე არსებობს');
        }
        ...
        const newCustomer = await _models_1.Customer.create({
            ...data,
            priceIndex: _config_1.priceIndex[Number(data.priceIndex)],
            paymentOption: _config_1.paymentOptions[Number(data.paymentOption)],
        });
