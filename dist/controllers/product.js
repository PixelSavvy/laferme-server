...
const getProducts = async (req, res) => {
  try {
    ...
    if (!foundProducts.length) return (0, _helpers_1.sendResponse)(res, 200, 'პროდუქტები ვერ მოიძებნა', []);
...
const getProduct = async (req, res) => {
  ...
  try {
    ...
    if (!foundProduct) return (0, _helpers_1.sendResponse)(res, 404, 'პროდუქტი ვერ მოიძებნა', {});
...
const addProduct = async (req, res) => {
  ...
  try {
    ...
    if (result.exists) return (0, _helpers_1.sendResponse)(res, 409, 'პროდუქტი მსგავსი პროდუქტის კოდით არსებობს');
