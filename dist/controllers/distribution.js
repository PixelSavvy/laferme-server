...
const getDistributionItems = async (req, res) => {
    try {
        ...
        if (!distributionItem.exists)
            return (0, _helpers_1.sendResponse)(res, 404, 'მსგავსი დისტრიბუცია ვერ მოიძებნა', distributionItem.data);
...
const updateDistributionItem = async (req, res) => {
    ...
    try {
        ...
        if (!updatedOrder.exists)
            return (0, _helpers_1.sendResponse)(res, 404, 'შეკვეთა ვერ მოიძებნა', updatedOrder.data);
