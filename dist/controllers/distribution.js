...
const getDistributionItem = async (req, res) => {
  ...
  try {
    const distributionItem =
      await _services_1.distributionServices.getDistributionItem(
        req,
        res,
        Number(id),
      );
...
const getDistributionItems = async (req, res) => {
  try {
    const distributionItem =
      await _services_1.distributionServices.getDistributionItems(req, res);
...
const updateDistributionItem = async (req, res) => {
  ...
  try {
    const updatedOrder =
      await _services_1.distributionServices.updateDistributionItem(
        req,
        res,
        parsedData.data,
      );
