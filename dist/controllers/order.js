...
const addOrder = async (req, res) => {
  ...
  try {
    ...
    if (!orderId) return (0, _helpers_1.sendResponse)(res, 404, 'შეცდომა შეკვეთის დამატებისას');
...
const getOrder = async (req, res) => {
  ...
  try {
    ...
    if (!order.exists) return (0, _helpers_1.sendResponse)(res, 202, 'შეკვეთა ვერ მოიძებნა', order.order);
...
const getOrders = async (req, res) => {
  try {
    ...
    if (!foundOrders.exists) return (0, _helpers_1.sendResponse)(res, 202, 'შეკვეთები ვერ მოიძებნა', foundOrders.orders);
