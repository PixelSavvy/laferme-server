...
router.route(`${_config_1.paths.app.distribution}/:id`).get(async (req, res) => {
    await _controllers_1.distributionController.getDistributionItem(req, res);
});
router.route(`${_config_1.paths.app.distribution}/:id`).patch(async (req, res) => {
    await _controllers_1.distributionController.updateDistributionItem(req, res);
});
