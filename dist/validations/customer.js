...
const PAYMENT_OPTIONS = Object.keys(_config_1.paymentOptions);
const PRICE_INDEXES = Object.keys(_config_1.priceIndex);
...
const newCustomerSchema = zod_1.z.object({
    ...
    priceIndex: zod_1.z.enum(PRICE_INDEXES, {
        required_error: REQUIRED_ERROR_MSG,
    }),
    paymentOption: zod_1.z.enum(PAYMENT_OPTIONS, {
        required_error: REQUIRED_ERROR_MSG,
    }),
