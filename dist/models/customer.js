...
const PAYMENT_OPTIONS = Object.values(_config_1.paymentOptions);
const PRICE_INDEXES = Object.values(_config_1.priceIndex);
const customerSchema = _validations_1.customerSchema.omit({
    createdAt: true,
    updatedAt: true,
    deletedAt: true,
});
const Customer = _lib_1.sequelize.define('Customer', {
    id: {
