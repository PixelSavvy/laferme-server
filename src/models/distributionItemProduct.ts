...
interface DistributionItemProductInstance
  extends Model<
      InferAttributes<DistributionItemProductInstance>,
      InferCreationAttributes<DistributionItemProductInstance>
    >,
    DistributionItemProductAttributes {}

const DistributionItemProduct =
  sequelize.define<DistributionItemProductInstance>(
